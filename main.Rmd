...
cleveland_plot <- function(input_data, yr, acs) {
  ...
  ggplot(data = plot_data,
         # mapping = aes(x = reorder(RegionName, rent), y = rent)) +
         mapping = aes(x = RegionName, y = rent)) +
    geom_line(aes(group = RegionName, color = burden), size = 1) +
    # geom_point(aes(y = median_hh_income/12), size = 5, color = "blue") +
    # geom_point(aes(y = income_diff), size = 5, color = "blue") +
