...
Areas with the largest differences between observed rent and calculated FMR were
...
cleveland_plot <- ggplot(data = cleveland_data,
  ...
  labs(title = "Zip Codes With Rent Furthest From Fair Market Rate",
       ...
       y = "Rent Index",
       color = "Value") +
  scale_colour_discrete(labels = c("HUD FMR", "Zillow Observed Rents")) +
  transition_manual(year)
...
```{r fig.width=10, fig.height=11, include = FALSE}
### ------------------
### Cleveland Dot Plot 
### include ACS data
...
```
We see here that missing data is much more of a concern for the first couple years, 2014 and 2015, especially in the upper range of rents, but less of an issue for the later years.
