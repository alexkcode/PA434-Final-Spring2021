...
Given the results of our correlation plots, questions of the statistical relation between those values and housing subsidy efficiency could be answered using statistical tests and in-depth time-series regression analysis. Further, research in urban planning may benefit from comparing measures of gentrification with housing subsidy data to better understand dynamics of displacement, disinvestment, and dispossession in urban environments.
