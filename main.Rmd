...
The following plot shows the aggregate trend lines of observed rents and FMR values. FMR values typically lag behind observed rents. This is due to the fact that HUD FMR values are calculated using rent estimates from ACS 5 year estimates from two years prior to the year of valuation. 
...
Differences between ZORI and FMR data, missing ZORI values for some months could effect the accuracy of 

### Missingness in data

```{r}
# TODO: Visualize missingness in zori data. This could use zori_raw or zori_staging I think. Whichver works best
```
