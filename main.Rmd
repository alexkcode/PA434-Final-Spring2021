...
The following plots visualize the change in the selected ZIP codes between 2014 and 2019 in terms of observed minus fair market rent values and rent burden. Rent burden is defined by HUD definition as a gross rent greater than 30% of income. Any rent above 50% of income is considered to be a severely rent burdened. The lines between the plots are colored based on whether the proportion of households in the ZIP code area were majority or minority rent burdened. 
